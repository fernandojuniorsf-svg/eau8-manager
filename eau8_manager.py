...
def init_db():
    ...
    if cur.fetchone() == 0:
        ...
        cur.execute("INSERT INTO usuarios (usuario, senha, nome, perfil, status, criado_em) VALUES (%s,%s,%s,%s,%s,%s)", ("equipe", SENHA_EQUIPE, "Equipe EUA8", "Equipe", "Ativo", "2026-05-03"))
    conn.commit()
    cur.close()
    conn.close()
