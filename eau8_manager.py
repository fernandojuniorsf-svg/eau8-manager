...
def dash_diario(mots, dt, sufixo="d"):
    ...
    st.download_button(t["exportar"],data=df[cols_ok].to_csv(index=False),file_name="motoristas_"+ds+".csv",mime="text/csv",key="dl_"+sufixo+"_"+ds)
...
if perfil == t["perfil_lider"]:
    ...
    with tabs[0]:
        ...
        with sub[1]:
            ...
            dash_diario(motoristas,dt,"dash")
        with sub[2]:
    ...
    with tabs[4]:
        ...
        dash_diario(motoristas,dt_h,"hist")
...
# ============================================================
    ...
    with tabs_o[1]:
        ...
        with sub_o[1]:
            ...
            dash_diario(motoristas,dt_od,"otr")
